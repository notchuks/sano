...
export const patients = pgTable("patients", {
  ...
  currentMedications: varchar("current_medications", { length: 500 }),
  pastMedicalHistory: varchar("past_medical_history", { length: 100 }),
  familyMedicalHistory: varchar("family_medical_history", { length: 100 }),
  identificationType: varchar("identification_type", { length: 100 }),
  identificationNumber: varchar("identification_number", { length: 100 }),
  identificationDocumentId: varchar("identification_document_id", { length: 100 }),
  identificationDocumentUrl: varchar("identification_document_url", { length: 500 }),
  primaryPhysician: varchar("primary_physician", { length: 100 }),
  createdAt: timestamp("created_at").default(sql`CURRENT_TIMESTAMP`).notNull(),
  updatedAt: timestamp("updated_at").default(sql`CURRENT_TIMESTAMP`).notNull(),
});
